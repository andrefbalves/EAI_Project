...
configurationRouter.get('/', async function (req, res, next) {
    ...
    res.render('configuration-engine', { title: 'Configuration Engine', terms: bestTerms, classes: classes, genre: 'All', configs: configs});
});
...
configurationRouter.post('/', async function (req, res, next) {
        ...
        res.render('configuration-engine', { title: 'Configuration Engine', terms: bestTerms, classes: classes,genre: req.body.genre, configs: configs});
});